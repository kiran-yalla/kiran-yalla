...
I'm **Kiran Kumar Yalla**, a Senior Platform Engineer with **16+ years** of experience architecting resilient, scalable, and automated infrastructure across enterprise environments. I thrive at the intersection of DevOps, Cloud Architecture, and Platform Engineering, turning complex systems into reliable, self-healing platforms.

- 🔭 Currently engineering cloud-native and AI-driven platforms with **AWS**, **Terraform**, and **CI/CD** pipelines
- - 🛠️ Deep expertise in **PEGA Platform Architecture** and enterprise **Database Administration**
- - ⚡ Passionate about **Site Reliability Engineering** and building systems that scale without breaking a sweat
- - 🌱 Constantly exploring **AI Platform Engineering** and next-gen cloud modernization strategies
- - 💬 Ask me about AWS, Terraform, CI/CD pipelines, PEGA, or Linux/Windows system architecture
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/kiran-kumar-yalla-57a4791b/)
